...
public class Templates {
    ...
    static {
        ...
        reportTemplate = template().setLocale(BRAZIL)
        ...
        //cria a imagem no topo do relatório
        HyperLinkBuilder link = hyperLink("http://www.dynamicreports.org");
        dynamicReportsComponent = cmp.horizontalList(cmp.image(Templates.class.getResource("/images/logovj.png")).setFixedDimension(60, 60),
